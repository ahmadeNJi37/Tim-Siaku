...
export default function HeaderStudentLayout({ auth, url }) {
    return (
        <>
            <Disclosure
                as="nav"
                className="border-b border-blue-300 border-opacity-25 bg-gradient-to-r from-blue-400 via-blue-600 to-blue-800 py-4 lg:border-none"
            >
                {({ open }) => (
                    <>
                        <div className="px-6 lg:px-24">
                            <div className="relative flex h-16 items-center justify-between">
                                <div className="flex items-center">
                                    <ApplicationLogo
                                        bgLogo="from-orange-400 via-orange-600 to-orange-800"
                                            ...
                                            <DropdownMenuTrigger asChild>
                                                ...
                                                >
                                                    <Avatar className="size-8 rounded-lg">
                                                        <AvatarImage src={auth?.avatar || "/images/User.png"} alt="Avatar"/>
                                                    ...
                                                    <div className="grid flex-1 text-left text-sm leading-tight">
                                                        ...
                                                        <span className="truncate text-xs">{auth?.student.student_number} {auth?.student?.classroom?.name}</span>
                                                    </div>
                            ...
                            <div className="pb-3 pt-4">
                                <div className="flex items-center px-5">
                                    ...
                                    <div className="ml-3">
                                        ...
                                        <div className="text-sm font-medium text-white">{auth?.student.student_number} {auth?.student?.classroom?.name}</div>
                                    </div>
                                </div>
